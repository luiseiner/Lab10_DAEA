...
namespace Lab10.Controllers
{
    public class categoriasController : Controller
    {
        ...
        {
            // Filtrar las categorías activas antes de pasarlas a la vista
            var categoriasActivas = db.categorias.Where(c => c.Activo == true).ToList();
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            if (categorias != null)
            {
                // Aquí actualizamos el campo Activo a false en lugar de eliminar el registro
